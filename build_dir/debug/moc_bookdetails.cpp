...
struct qt_meta_stringdata_bookdetails_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_bookdetails_t, stringdata0) + ofs \
...
static const uint qt_meta_data_bookdetails[] = {
...
QT_INIT_METAOBJECT const QMetaObject bookdetails::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_bookdetails.data,
    qt_meta_data_bookdetails,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *bookdetails::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_bookdetails.stringdata0))
